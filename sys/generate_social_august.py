...
for line in lines:
    if line.startswith("## Tháng 8/2026"):
        in_target_month = True
    elif line.startswith("## Tháng ") and "8/2026" not in line:
        in_target_month = False
...
print(f"Done generating {count} social posts for August 2026 and updating content_calendar.md!")
