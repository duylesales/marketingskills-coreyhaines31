...
for line in lines:
    if line.startswith("## Tháng 4/2027"):
        in_target_month = True
    elif line.startswith("## Tháng ") and "4/2027" not in line:
        in_target_month = False
...
print(f"Done generating {count} social posts for April 2027 and updating content_calendar.md!")
